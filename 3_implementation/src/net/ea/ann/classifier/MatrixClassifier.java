...
public class MatrixClassifier extends MatrixClassifier0 {
	 ...
	 */
	protected MatrixClassifier(int neuronChannel, Function activateRef, Function convActivateRef, Id idRef) {
	 ...
	 * @param convActivateRef convolutional activation function.
	 */
	protected MatrixClassifier(int neuronChannel, Function activateRef, Function convActivateRef) {
	 ...
	 * @param activateRef activation function.
	 */
	protected MatrixClassifier(int neuronChannel, Function activateRef) {
	 ...
	 * @param neuronChannel neuron channel.
	 */
	protected MatrixClassifier(int neuronChannel) {
