...
/**
 * This class is an implementation of doing event for PSO.
 * 
 * @author Loc Nguyen
 * @version 1.0
 *
 */
public class PSODoEventImpl extends EventObject implements PSODoEvent {
	 ...
	 */
	public PSODoEventImpl(Object source, Type type, String algName, Serializable learnResult, int progressStep, int progressTotalEstimated) {
		super(source);
		this.type = type;
